...
manifest_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'bucket', 'lessmsi.json')
upstream = "https://raw.githubusercontent.com/ScoopInstaller/Main/master/bucket/lessmsi.json"
